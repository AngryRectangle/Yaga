...
using Yaga.Reactive.Binding.Observable;
using Yaga.Reactive.Binding.Observable.ConcreteObservables;

namespace Yaga.Reactive.Binding
{
    ...
    public class BindingContext : IDisposable
    {
        ...
        public BindObservable<T> Bind<T>(Reactive.IObservable<T> observable)
        ...
        public BindStringObservable Bind(Reactive.IObservable<string> observable)
            => new BindStringObservable(this, observable);
        public BindIntObservable Bind(Reactive.IObservable<int> observable)
